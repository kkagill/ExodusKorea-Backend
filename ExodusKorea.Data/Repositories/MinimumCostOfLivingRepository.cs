...
{
    public class MinimumCostOfLivingRepository : EntityBaseRepository<MinimumCostOfLiving>, IMinimumCostOfLivingRepository
    {
        private readonly ExodusKoreaContext _context;
        private readonly IConfiguration _config;
        private readonly AppSettings _appSettings;

        public MinimumCostOfLivingRepository(ExodusKoreaContext context,
