...
{
    public class VideoCommentLikeRepository : EntityBaseRepository<CommentLike>, IVideoCommentLikeRepository
    {
        private readonly ExodusKoreaContext _context;
        private readonly IConfiguration _config;

        public VideoCommentLikeRepository(ExodusKoreaContext context,
