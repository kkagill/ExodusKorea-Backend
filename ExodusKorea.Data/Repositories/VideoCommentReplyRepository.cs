...
{
    public class VideoCommentReplyRepository : EntityBaseRepository<VideoCommentReply>, IVideoCommentReplyRepository
    {
        private readonly ExodusKoreaContext _context;
        private readonly IConfiguration _config;

        public VideoCommentReplyRepository(ExodusKoreaContext context,
