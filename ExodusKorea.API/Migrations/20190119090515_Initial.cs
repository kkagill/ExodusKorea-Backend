        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsGoogleDriveVideo = table.Column<byte>(nullable: false),
                    NickName = table.Column<string>(nullable: true),
                    UserId = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UploaderId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Name = table.Column<string>(nullable: true),
                    YouTubeChannelThumbnailUrl = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    JobsInDemandId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CountryId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobsInDemand", x => x.JobsInDemandId);
                    table.ForeignKey(
                        name: "FK_JobsInDemand_Country_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Country",
                        principalColumn: "CountryId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsGoogleDriveVideo = table.Column<byte>(nullable: false),
                    JobsInDemandId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VideoPost_JobsInDemand_JobsInDemandId",
                        column: x => x.JobsInDemandId,
                        principalTable: "JobsInDemand",
                        principalColumn: "JobsInDemandId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobsInDemand_CountryId",
                table: "JobsInDemand",
                column: "CountryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VideoPost_JobsInDemandId",
                table: "VideoPost",
                column: "JobsInDemandId");
